# 1 "triangulation.c"
# 1 "/home/raffalli/Enseignements/INFO821_Infographie/src2013//"
# 1 "<command-line>"
# 1 "triangulation.c"
...
# 1 "/usr/local/include/gc.h" 1 3

# 1 "/usr/local/include/gc/gc.h" 1 3
# 2 "/usr/local/include/gc.h" 2 3
# 8 "tiny_gc.h" 2
# 5 "triangulation.c" 2
...
void add_vertex_to_edge(half_edge e1, void* v3) {
  ...
  ((e1->next == ((void *)0)) ? (void) (0) : __assert_fail ("e1->next == ((void *)0)", "triangulation.c", 65, __PRETTY_FUNCTION__));
  ((e1->opp->prev == ((void *)0)) ? (void) (0) : __assert_fail ("e1->opp->prev == ((void *)0)", "triangulation.c", 66, __PRETTY_FUNCTION__));
...
void close_triangle(half_edge e1, half_edge e2) {
  ...
  ((e1->next == ((void *)0)) ? (void) (0) : __assert_fail ("e1->next == ((void *)0)", "triangulation.c", 82, __PRETTY_FUNCTION__));
  ((e1->opp->prev == ((void *)0)) ? (void) (0) : __assert_fail ("e1->opp->prev == ((void *)0)", "triangulation.c", 83, __PRETTY_FUNCTION__));
  ((e2->next == ((void *)0)) ? (void) (0) : __assert_fail ("e2->next == ((void *)0)", "triangulation.c", 84, __PRETTY_FUNCTION__));
  ((e2->opp->prev == ((void *)0)) ? (void) (0) : __assert_fail ("e2->opp->prev == ((void *)0)", "triangulation.c", 85, __PRETTY_FUNCTION__));
  ((e2->vertex == e1 -> opp -> vertex) ? (void) (0) : __assert_fail ("e2->vertex == e1 -> opp -> vertex", "triangulation.c", 86, __PRETTY_FUNCTION__));
...
void fill_triangle(half_edge e1, half_edge e2, half_edge e3) {
  ...
  ((e1->next == ((void *)0)) ? (void) (0) : __assert_fail ("e1->next == ((void *)0)", "triangulation.c", 101, __PRETTY_FUNCTION__));
  ((e1->opp->prev == ((void *)0)) ? (void) (0) : __assert_fail ("e1->opp->prev == ((void *)0)", "triangulation.c", 102, __PRETTY_FUNCTION__));
  ((e2->next == ((void *)0)) ? (void) (0) : __assert_fail ("e2->next == ((void *)0)", "triangulation.c", 103, __PRETTY_FUNCTION__));
  ((e2->opp->prev == ((void *)0)) ? (void) (0) : __assert_fail ("e2->opp->prev == ((void *)0)", "triangulation.c", 104, __PRETTY_FUNCTION__));
  ((e3->next == ((void *)0)) ? (void) (0) : __assert_fail ("e3->next == ((void *)0)", "triangulation.c", 105, __PRETTY_FUNCTION__));
  ((e3->opp->prev == ((void *)0)) ? (void) (0) : __assert_fail ("e3->opp->prev == ((void *)0)", "triangulation.c", 106, __PRETTY_FUNCTION__));
  ((e2->vertex == e1 -> opp -> vertex) ? (void) (0) : __assert_fail ("e2->vertex == e1 -> opp -> vertex", "triangulation.c", 107, __PRETTY_FUNCTION__));
  ((e3->vertex == e2 -> opp -> vertex) ? (void) (0) : __assert_fail ("e3->vertex == e2 -> opp -> vertex", "triangulation.c", 108, __PRETTY_FUNCTION__));
  ((e1->vertex == e3 -> opp -> vertex) ? (void) (0) : __assert_fail ("e1->vertex == e3 -> opp -> vertex", "triangulation.c", 109, __PRETTY_FUNCTION__));
...
void remove_triangle(half_edge e1) {
  ...
  e1->next = ((void *)0); ne1->prev = ((void *)0);
  e2->next = ((void *)0); ne2->prev = ((void *)0);
  e3->next = ((void *)0); ne3->prev = ((void *)0);
}
